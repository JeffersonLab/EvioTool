...
#ifndef __HPSEvioReader__HPSEvioReader__
#define __HPSEvioReader__HPSEvioReader__
...
{
public:
  HPSEvioReader(const char *filename=nullptr, const char *dict_filename=nullptr);
  ~HPSEvioReader();
  void init(void);
